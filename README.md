...
![正向计时](screenshots/正向计时.png)

![倒计时](screenshots/倒计时.png)

- **自动休息 + 每日目标**：学习结束自动休息（依照比例计算），设定目标并自动记录每日时长。

![自动休息](screenshots/自动休息.png)

![每日目标](screenshots/每日目标.png)

- **闹钟 + 待办清单**：提供闹钟与待办清单功能，避免忘记重要事项。

![闹钟](screenshots/闹钟.png)

![待办清单](screenshots/待办清单.png)
...
从 [Releases](https://github.com/muyangren-k/TTomatoTimer/releases) 下载 `TomatoTimer-v1.0.0-Windows.exe`，双击运行（便携单文件，无需安装）。
